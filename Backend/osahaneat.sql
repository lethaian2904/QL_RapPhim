...
alter table rating_food add  constraint fk_rating_user_id foreign key(user_id) references users(id);
alter table rating_food add  constraint fk_rating_food_id foreign key(food_id) references food(id);
...
alter table orders add  constraint fk_orders_res_id foreign key(res_id) references users(id);
